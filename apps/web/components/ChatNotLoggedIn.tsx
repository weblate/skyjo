...
interface ChatNotLoggedInProps {
  className?: ClassValue
}
const ChatNotLoggedIn = ({ className }: ChatNotLoggedInProps) => {
  const t = useTranslations("components.ChatNotLoggedIn")
  return (
    <div
      className={cn(
...
export default ChatNotLoggedIn
