...
const TabsTrigger = ({
  ...
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "z-10 data-[state=active]:border-[1.5px] data-[state=active]:border-b-container dark:data-[state=active]:border-b-dark-container border-black dark:border-dark-border rounded-sm rounded-b-none inline-flex items-center justify-center whitespace-nowrap px-3 h-full text-sm text-black dark:text-dark-font font-medium ring-offset-white -outline-offset-2 focus-visible:outline-2 focus-visible:outline-black  focus-visible:outline-offset-[-6px] dark:focus-visible:outline-dark-border disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300 dark:data-[state=active]:text-slate-50 data-[state=active]:bg-container dark:data-[state=active]:bg-dark-container",
      className,
    )}
    {...props}
  />
...
const TabsContent = ({
  ...
  <TabsPrimitive.Content
    ...
    tabIndex={-1}
    className={cn(
      "p-6 bg-container dark:bg-dark-container grow overflow-y-auto",
      className,
    )}
    {...props}
  />
