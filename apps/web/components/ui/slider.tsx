...
const Slider = ({
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-black dark:border-dark-border bg-white dark:bg-dark-input ring-offset-white transition-all duration-200 -outline-offset-2 focus-visible:outline-2 focus-visible:outline-black focus-visible:outline-offset-[-6px] dark:focus-visible:outline-dark-border cursor-pointer data-disabled:pointer-events-none" />
  </SliderPrimitive.Root>
)
