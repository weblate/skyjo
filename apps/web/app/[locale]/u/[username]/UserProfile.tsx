  ...
  "rounded-full border-2 border-black size-20 flex items-center justify-center",
  {
    variants: {
      avatar: {
        ...
        [CoreConstants.AVATARS.HEDGEHOG]: "bg-emerald-200 dark:bg-emerald-400",
        [CoreConstants.AVATARS.PANDA]: "bg-amber-200 dark:bg-amber-400",
      },
    },
  },
)
